...
funds_url = 'https://trader.degiro.nl/a/secure/v3/funds?iDisplayStart=0&iDisplayLength=1000'
total_portfolio_url = 'https://trader.degiro.nl/a/secure/v3/update?totalPortfolio=0'
portfolio_url = 'https://trader.degiro.nl/a/secure/v3/update?portfolio=0'
